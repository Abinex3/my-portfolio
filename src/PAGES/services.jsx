...
// import line from '../assets/Curve Line.svg';
        ...
        <Element name="services">
            <div id="service-container">
                <div className="service-header">
                    ...
                    {/* <p className="service-skill">Lorem ipsum dolor sit amet consectetur adipisicing elit. Itaque consequatur perspiciatis quos sapiente ipsum, ratione corrupti quasi adipisci, vero quis maxime labore tempora suscipit sed doloremque laboriosam, debitis nam impedit!</p> */}
                </div>
                ...
                <div className="my-services">
                    <div className="container">
                        <div className="card">
                                ...
                                <div className="content">
                                    <img src={design} className="ui"></img>
